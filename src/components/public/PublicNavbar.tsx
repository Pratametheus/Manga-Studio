          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-5">
              ...
              <button 
                ...
                className="md:hidden text-gray-400 hover:text-white transition-colors z-[60]"
              >
          ...
          >
            ...
            <div className="mt-auto mb-10 flex flex-col items-center gap-6">
              <div className="flex items-center gap-6">
                {instagramUrl && (
                  <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-yellow-400 transition-colors">
                    Instagram
                  </a>
                )}
                {xUrl && (
                  <a href={xUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-yellow-400 transition-colors">
                    Twitter / X
                  </a>
                )}
              </div>
              ...
              {contactEmail && (
                <a 
                  ...
                  className="w-full py-4 bg-yellow-400 text-black text-center font-black text-lg tracking-widest uppercase rounded-lg"
                >
                  Hubungi Kami
                </a>
              )}
