          ...
          <div className="flex justify-between items-end">
            <div>
              <div className="flex items-center gap-3 mb-1">
                <span className="px-2.5 py-1 bg-indigo-50 text-indigo-700 rounded-md text-xs font-bold uppercase tracking-wider">
                  STUDIO WORKSPACE
                </span>
              </div>
              <h1 className="text-3xl font-bold text-gray-900 tracking-tight">{manga.judul}</h1>
            </div>
          </div>
        </header>
